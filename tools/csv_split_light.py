...
id = 1
countriesMap = {}
countryNameData = pd.read_csv(os.path.join(dirname, "../dataset/country_name.csv"))
countryPopulationData = pd.read_csv(os.path.join(dirname, "../dataset/country_population.csv"))
